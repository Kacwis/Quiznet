...
{
    /// <inheritdoc />
    public partial class AddedQuestionsAnswersAndCategoryTablesAddedAllTableRequiredForImplementationOfGameplaySegment : Migration
    {
        /// <inheritdoc />
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlayerAnswers_Rounds_GameRoundId",
