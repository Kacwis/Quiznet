...
namespace quiznet_api.Migrations
{
    ...
    [Migration("20230810090454_AddedAvatarTable")]
    partial class AddedAvatarTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("quiznet_api.Models.Avatar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("quiznet_api.Models.Player", b =>
                {
                    b.HasOne("quiznet_api.Models.Avatar", "Avatar")
                        .WithMany("Players")
